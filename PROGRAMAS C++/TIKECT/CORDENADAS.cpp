...
gotoxy(20,22);cout<<"HOLA MUNDO"; //En esta linea de codigo se mnada a llamar a nuestra funcion creada gotoxy, y se coloca un numero N en la posiscion X and Y para que el texto colocado en cout aparezaca en una posicion, como si fuera un plano carteciano.
